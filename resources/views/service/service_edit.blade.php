...
<div class="row">
   <div class="col-md-12">
        <div class="card card-deafult">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('service.update', $service_info->id) }}" >
                    @csrf
                    <div class="form-group row">
                        <label for="short_title" class="col-md-2 col-form-label text-md-left">  Title </label>
                        <div class="col-md-5">
                            <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $service_info->title}}" required >
                        ...
                        <div class="col-md-4">
                            <input type="text" name="icon" id="icon" class="form-control"  value="{{ $service_info->icon}}"/>
                        </div>
                    </div>
                    <div class="form-group row">
